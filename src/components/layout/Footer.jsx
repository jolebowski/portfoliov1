    ...
    <footer className="relative bg-deep-space pt-20 pb-10 border-t border-white/5">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <h3 className="text-white font-bold mb-4">{t('footer.navigation')}</h3>
            <ul className="space-y-2 text-muted-mist">
              <li><a href="/" className="hover:text-electric-violet transition-colors">{t('nav.home')}</a></li>
              <li><a href="/projects" className="hover:text-electric-violet transition-colors">{t('nav.projects')}</a></li>
              <li><a href="/about" className="hover:text-electric-violet transition-colors">{t('nav.about')}</a></li>
              <li><a href="/contact" className="hover:text-electric-violet transition-colors">{t('nav.contact')}</a></li>
            </ul>
          </div>
          <div>
            <h3 className="text-white font-bold mb-4">{t('footer.social')}</h3>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-muted-mist">
          <p>© {new Date().getFullYear()} Jordan Moreira. {t('footer.rights')}</p>
